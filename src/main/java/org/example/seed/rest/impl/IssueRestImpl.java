...
public class IssueRestImpl implements IssueRest {
    ...
    public Callable<ResponseIssueEvent> getIssue(@PathVariable("id") final String id) throws ExecutionException, InterruptedException {
    ...
    public void deleteIssue(@PathVariable("id") final String id) {
